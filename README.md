...
## 📝Finalidade
- Site com informações sobre o jogo e opção de compra em diferentes plataformas.

## 👨‍💻Funcionalidade
- [x] Projeto feito com HTML, CSS e JavaScript.

- [x] JavaScript foi utilizado para dar funcionalidade ao botão "Selecione a plataforma".

- [x] Ao clicar no botão o usuário terá opções de plataformas disponíveis para compra do jogo.

## Prints

### 🖥️Versão Desktop
<img src="./src/img/readme/desktop.png">

### 🤳Versão Tablet
<img src="./src/img/readme/tablet.png">

### 📱Versão Mobile
<img src="./src/img/readme/mobile.png">
